					...
					>
						...
						<div className="flex w-[75%] items-center justify-center md:w-[65%]">
							<h3 className="fantasy-text text-white italic text-left text-sm sm:text-lg md:text-lg lg:text-2xl">
								&nbsp;&nbsp;&nbsp;&nbsp;"About twenty years after the War of Flames... The world has lost an Alf tree, and the ruins of the war are still being repaired. The should be protectors of
								the Somnium are weakened warring with each other. Evil is on the rise siezing the opportunity. Adventurers are needed like never before."
							</h3>
						</div>
					</div>
					<div className="flex flex-col w-[85%] lg:flex-row  items-center justify-center py-20 gap-12 md:gap-0 rounded-lg">
						...
						<div className="flex flex-col w-[75%] items-left justify-center gap-6">
							...
							<FadeInTextAnimation onetime={false}>
								...
								<p className="leading-7 [&:not(:first-child)]:mt-6">
									What makes LoTA unique is the access to arcane powers being scarce, and other magical practices such as holy magic and nature magic being questioned by The Church of The Eight.
									People who carry these powers tend to not reveal themselves out of the fear that they might find themselves burning in a steak, their sentence read by the bishop of their diocese.
									The practice of arcane magic is forbid to humans by the elves after the War of Flames. However, this reservence is different in countries other than the Senate and People of Utland.
								</p>
								<p className="leading-7 [&:not(:first-child)]:mt-6">
									Especially countries like Gerontocracy of Ard Caëd, Kingdom of Dol Caëd, and Veretia is where gnomes, halflings, and elves interact with arcane in their lives more freely, connected
									to their differences in beliefs with SPQU. They became more conservative with their arcane after the War of Flames, and the destruction that humans caused.
								</p>
								<p className="leading-7 [&:not(:first-child)]:mt-6">
